...
def create_person_list(people: list) -> list:
    ...
    for index in range(0, len(people)):
        if "wife" in people[index] and people[index]["wife"] is not None and not hasattr(result[index], "wife"):
        ...
        elif "husband" in people[index] and people[index]["husband"] is not None and \
            not hasattr(result[index], "husband"):
